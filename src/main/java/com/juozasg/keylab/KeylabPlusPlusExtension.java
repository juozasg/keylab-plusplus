...
public class KeylabPlusPlusExtension extends ControllerExtension
{
   protected KeylabPlusPlusExtension(final KeylabPlusPlusExtensionDefinition definition, final ControllerHost host)
   {
   ...
   public void init()
   {
      ...
      host.showPopupNotification("keylab-plusplus Initialized");
   }
   ...
   public void exit()
   {
      ...
      getHost().showPopupNotification("keylab-plusplus Exited");
   }
